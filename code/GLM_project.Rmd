...
df.test.pred <- cbind(df.test[,2:4], df.test.pred )
...
+ proposer une plus grande granularité temporelle des données (3 par jours), avec une sortie pluie.demain en probabilité plutôt que binaire
+ inclure des variable météorologiques (agrégées) qui correspondrait à un historique des jours précédants, pour avoir une notion de série temporelle dans l'impact de la pluie demain, pour ne pas seulement prendre en compte les phénomènes présents
+